function [step_height,base_length,ramp_location] = splitter_dimmensions_mark(alpha_ramp,distance_beamsplitter_tip,fov)
...
ramp_location.deepest2=[ -base_length/2 , 0 , -(distance_beamsplitter_tip+step_height) ];
...
ramp_location.vector2=ramp_location.deepest2-ramp_location.highest;
