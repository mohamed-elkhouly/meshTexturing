...
%     scene_name='82sE5b5pLXE_1'; %0,1,3
    ...
    try
        ...
        tic
        mesh=convert_python_generated_mat_to_similar_to_ours_v_0_4(dahy,region_file_no_simplification_path,use_simplified,folder_path,region_number,scene_name);
        toc
