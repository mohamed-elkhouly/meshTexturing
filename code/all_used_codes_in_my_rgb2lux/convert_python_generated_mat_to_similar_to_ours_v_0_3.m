function  mesh=convert_python_generated_mat_to_similar_to_ours_v_0_3(in_var,original_path,simplified,folder_path,region_number,scene_name)
...
%% enclosing our mesh inside a sphere. comment it to remove the sphere
% [x,y,z]=sphere(400);
% wide_range=30;
% x=x*wide_range;
% y=y*wide_range;
