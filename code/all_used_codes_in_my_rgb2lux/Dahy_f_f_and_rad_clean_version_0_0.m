...
equal_rho_flag=0;% this flag when activated it assign same value of rho for all faces.
...
if room_num==0
    ...
    try
        ...
        tic
        mesh=convert_python_generated_mat_to_similar_to_ours(dahy,region_file_no_simplification_path,use_simplified,folder_path,region_number);
        toc
...
tic;[F_ldc_lsc] = viewFactors4OPCODE_sparse_version_0_0(mesh, 100, 1);
