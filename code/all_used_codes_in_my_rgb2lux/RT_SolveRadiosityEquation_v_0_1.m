function [R,H,Q] = RT_SolveRadiosityEquation_v_0_1(F,rho,E,imethod,K,rho_t,g_vec,itermax)
%
...
% %   Iteration 2 the light emission will be from batches illuminated at
% %  last iteration
%  E=R;
% %  R=E;
%  norme=0.001*norm(E);
