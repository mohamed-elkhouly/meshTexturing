...
%         delete([scene_path,scene_name,'/created_mesh_regions/',mesh_file])
        ...
        tic
        mesh=convert_python_generated_mat_to_similar_to_ours_v_0_2(dahy,region_file_no_simplification_path,use_simplified,folder_path,region_number,scene_name);
        toc
...
tic;[F_ldc_lsc] = viewFactors4OPCODE_sparse_version_0_3(mesh, 1000, 1);toc
