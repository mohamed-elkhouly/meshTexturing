function [faces_of_current_vertex,which_vertex_in_face]=get_neighborhood_faces_up_to_level(fv,vertex_faces,vertex_index_in_faces,vertex_index,level)
...
faces_of_current_vertex=vertex_faces(vertex_index,:);
    ...
    faces_for_loop=faces_of_current_vertex;
        for i=2:level
        required_vertex_index=fv.faces(faces_for_loop(:),:);
