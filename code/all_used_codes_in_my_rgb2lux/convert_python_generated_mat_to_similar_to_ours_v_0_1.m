function  mesh=convert_python_generated_mat_to_similar_to_ours_v_0_1(in_var,original_path,simplified,folder_path,region_number)
...
mesh=get_specular_faces_v_0_1(mesh,folder_path,region_number);