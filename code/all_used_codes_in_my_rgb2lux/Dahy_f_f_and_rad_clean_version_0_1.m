...
if room_num==0
    ...
    try
        ...
        tic
        mesh=convert_python_generated_mat_to_similar_to_ours_v_0_1(dahy,region_file_no_simplification_path,use_simplified,folder_path,region_number);
        toc
...
tic;[F_ldc_lsc] = viewFactors4OPCODE_sparse_version_0_1(mesh, 1000, 1);toc
