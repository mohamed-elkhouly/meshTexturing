...
%% Set new Xaxis limits, ticks and subticks the same as original ones (by link) ...
    ...
    set(nAxis, 'fontsize', get(axisH, 'fontsize'));
    xtickangle(nAxis,45);
...
%     set(nAxis, 'xtickLabel',  num2str(evalin('base', newXtickLabel_command)));
%     set(nAxis, 'XTickLabel',  {'', '0', '1', '2', '3', '4', '5', '6', '7', '8', '34', '37', '38', '47', '48', '78', '347', '348', '378', '478', '3478', '12', '15', '16', '25', '26', '56', '125', '126', '156', '256', '1256', '12345678', '34(75%)', '37(75%)', '38(25%)', '47(25%)', '48(50%)', '78(50%)', '348(30-40-80%)', '478(40-70-80%)', '3478(20%)', '3478(65%)', '37(30-70%)', '48(40-80%)'});
%     set(nAxis, 'XTickLabel',  {'', '12345678', '1', '2', '3', '4', '5', '6', '7', '8', '34', '37', '38', '47', '48', '78', '347', '348', '378', '478', '3478', '12', '15', '16', '25', '26', '56', '125', '126', '156', '256', '1256', '34(75%)', '37(75%)', '38(25%)', '47(25%)', '48(50%)', '78(50%)', '348(30-40-80%)', '478(40-70-80%)', '3478(20%)', '3478(65%)', '37(30-70%)', '48(40-80%)'});
    set(nAxis, 'XTickLabel',  {'', '0', '1', '2', '3', '4', '5', '6', '7', '8', '12', '15', '34', '34', '2345', '2345', '2345', '3478', '3478', '345678', '12345678', '12345678', '12345678', '12345678', '12345678'});
%% but label for new axis
    ...
    xlabelHandle = get(nAxis, 'xlabel');
    xlabelPos = get(xlabelHandle, 'Position');
    % change the x value  to 0
    xlabelPos(2) = xlabelPos(2) - 20; % set position of title on top axis
    % update the position
