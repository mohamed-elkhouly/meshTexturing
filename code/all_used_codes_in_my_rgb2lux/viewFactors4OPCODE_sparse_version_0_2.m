function [F] = viewFactors4OPCODE_sparse_version_0_2(cadModel, rays, method, ldc, Fij, ldcPatches)
...
%         ray_index
        ...
        [hit,tt,idxx,bary,xnodee] = t.intersect(required_centroids(ray_index,:)',mirrored_ray');
        intersections=idxx;
%         intersections = unique(idxx); % find which faces are hit from the rays
