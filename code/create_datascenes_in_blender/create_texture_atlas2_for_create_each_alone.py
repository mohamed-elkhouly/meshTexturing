...
max_resolution_cabapility=8192
max_GPU_cabability=8192;bpy.data.scenes['Scene'].cycles.samples=3000
...
for obj in bpy.context.scene.objects:
    ...
    if obj.type == "MESH" and obj.hide==False:
        ...
        if(resolution>max_resolution_cabapility):
            resolution=max_resolution_cabapility
        ...
        bpy.data.scenes['Scene'].render.tile_x=max_GPU_cabability
        bpy.data.scenes['Scene'].render.tile_y=max_GPU_cabability
