function luminance3=do_balance_operation_pixels(number_of_all_pixels,all_faces_in_correspondences,estimated_g,luminance,region_faces_backup)
face_appeared_flag=false(number_of_all_pixels,1);
