function  [num_faces_in_frames, groups]=get_faces_colors_for_each_group_from_each_frame_separately_lab(mesh, all_used_groups_faces, region_frames, region_faces,scene_name,folder_path, start_of_faces_indexing, end_of_faces_indexing,using_different_mesh)
