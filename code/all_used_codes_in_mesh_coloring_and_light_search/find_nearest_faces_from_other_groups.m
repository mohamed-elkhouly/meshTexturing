function [faces_correspondences,all_used_edge_faces]=find_nearest_faces_from_other_groups(mesh,regions_edge_faces,region_faces,region_number,tempmesh_faces,dot_prod_matrix,plot_lines)
