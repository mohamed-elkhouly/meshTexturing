function  mesh=convert_python_generated_mat_to_similar_to_ours(in_var,original_path,simplified,poses_path)
...
%     mesh.lightPatches.allLights=double(in_var{5})+1;
% end
% mesh=read_poses(mesh,poses_path);