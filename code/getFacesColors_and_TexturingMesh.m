function  [num_faces_in_frames,groups,faces_colors]=getFacesColors_and_TexturingMesh(mesh)
...
for index=1:size(region_frames,1)
    ...
    [all_images]=prepare_our_image(frame_number,index,all_images,mesh.data_path) ;    
